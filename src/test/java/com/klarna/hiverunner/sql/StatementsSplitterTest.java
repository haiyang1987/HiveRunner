...
public class StatementsSplitterTest {
  ...
  public void testCommentRemoved() {
    String str = "foo; -- baz";
    List expected = Arrays.asList("foo");
    Assert.assertEquals(expected, StatementsSplitter.splitStatementsRemoveComments(str));
  }

  @Test
  public void testCommentRemovedMultiline() {
    String str = "foo;\n -- b;\nbar;";
    List expected = Arrays.asList("foo", "bar");
    Assert.assertEquals(expected, StatementsSplitter.splitStatementsRemoveComments(str));
  }
  ...
  @Test
  public void testCommentAtStartRemoved() {
    String str = "-- foo\n -- b;ar\nbaz";
    List expected = Arrays.asList(" baz");
    Assert.assertEquals(expected, StatementsSplitter.splitStatementsRemoveComments(str));
  }
  ...
  public void realLifeWithComments() {
    ...
    Assert.assertEquals(Arrays.asList(firstStatement), StatementsSplitter.splitStatements(firstStatement + ";\n"));
  }
